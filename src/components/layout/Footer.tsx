        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-slate-400 text-lg leading-relaxed max-w-sm mb-10 font-medium">
              The world's most trusted decentralized platform for secure voting
              competitions and premium event ticketing.
            </p>
          ...
          <div className="lg:col-span-2">
            <h4 className="text-white font-black uppercase tracking-[0.2em] text-[10px] mb-8">
              Platform
            </h4>
            ...
            <ul className="space-y-6 font-bold text-sm">
              <li className="flex items-start gap-4">
                ...
                <span className="leading-relaxed">
                  A42 Innovation Drive, <br />
                  Tech City, Accra, Ghana
                </span>
              </li>
