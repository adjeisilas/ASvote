            ...
            {user ? (
              <>
                <Link
                  ...
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <Button className="w-full bg-indigo-600 font-bold rounded-xl h-12">
                    Dashboard
                  </Button>
                </Link>
                <Button
                  variant="outline"
                  onClick={handleLogout}
                  className="w-full font-bold rounded-xl h-12 text-red-500"
                >
                  Logout
                </Button>
              </>
              ...
              <>
                <Link to="/login" onClick={() => setMobileMenuOpen(false)}>
                  <Button
                    variant="outline"
                    className="w-full font-bold rounded-xl h-12 border-slate-200"
                  >
                    Login
                  </Button>
                </Link>
                <Link to="/register" onClick={() => setMobileMenuOpen(false)}>
                  <Button className="w-full bg-slate-900 font-bold rounded-xl h-12">
                    Get Started
                  </Button>
                </Link>
              </>
