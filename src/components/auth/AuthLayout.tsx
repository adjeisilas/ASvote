    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-background selection:bg-indigo-100 selection:text-indigo-600 transition-colors duration-300">
      ...
      <div className="hidden lg:flex flex-col lg:sticky lg:top-0 lg:h-screen relative overflow-hidden bg-slate-950 dark:bg-[#050505] border-r border-border">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-linear-to-tr from-slate-950 via-slate-900 to-indigo-950 opacity-40"></div>
        </div>
          ...
          <div>
            ...
            >
              ...
              <p className="text-slate-400 text-base lg:text-lg font-medium max-w-md leading-relaxed">
                Join a community of forward-thinking organizers leveraging
                data-driven decision making and secure voting.
              </p>
            </motion.div>
            ...
            >
              <div>
                ...
                <p className="text-slate-500 text-[10px] font-medium uppercase tracking-widest leading-loose">
                  Managed globally
                </p>
              </div>
              <div>
      ...
      <div className="flex flex-col relative overflow-hidden bg-background">
        ...
        <div className="grow flex items-center justify-center p-6 sm:p-8 lg:p-12 overflow-y-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
          ...
          >
            <div className={`${title || subtitle ? "mb-8" : "mb-0"}`}>
              {title && (
                <h1 className="text-3xl sm:text-4xl font-black tracking-tighter text-foreground mb-2">
                  {title}
                </h1>
              )}
              {subtitle && (
