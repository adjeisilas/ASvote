...
import Contact from './views/ContactScreen';
import HelpCenter from './views/HelpCenterScreen';
import PrivacyHub from './views/PrivacyHubScreen';
import LegalTerms from './views/LegalTermsScreen';
import EventDetail from './views/EventDetail';
import Login from './views/LoginScreen';
import Register from './views/RegisterScreen';
import ForgotPassword from './views/ForgotPasswordScreen';
import ResetPassword from './views/ResetPasswordScreen';
import AdminDashboard from './views/AdminDashboard';
import AdminOrganizerDetail from './views/AdminOrganizerDetail';
import OrganizerDashboard from './views/OrganizerDashboardScreen';
