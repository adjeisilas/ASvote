...
import HelpCenter from './views/HelpCenterPage';
import PrivacyHub from './views/PrivacyHubPage';
import LegalTerms from './views/LegalTermsPage';
...
import OrganizerDashboard from './views/OrganizerDashboardPage';
